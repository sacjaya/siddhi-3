...
public class AttributeProcessorFactory {
    ...
    public static AttributeProcessor createAttributeProcessor( Expression[] expressions,  Map<String, StreamDefinition> tempStreamDefinitionMap,
        ...
        return new AggregationAttributeProcessor(expressions, tempStreamDefinitionMap,metaStreamEvent, variableExpressionExecutors,outputAttributeAggregatorFactory,siddhiContext);
    }
