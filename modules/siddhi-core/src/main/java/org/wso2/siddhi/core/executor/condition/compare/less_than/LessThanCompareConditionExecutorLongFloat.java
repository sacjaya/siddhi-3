...
public class LessThanCompareConditionExecutorLongFloat
        extends LessThenCompareConditionExecutor {


    public LessThanCompareConditionExecutorLongFloat(ExpressionExecutor leftExpressionExecutor,
