...
public class GreaterThanCompareConditionExecutorDoubleFloat extends
        GreaterThenCompareConditionExecutor {


    public GreaterThanCompareConditionExecutorDoubleFloat(ExpressionExecutor leftExpressionExecutor,
