...
public class LessThanCompareConditionExecutorLongDouble extends
        LessThenCompareConditionExecutor {


    public LessThanCompareConditionExecutorLongDouble(ExpressionExecutor leftExpressionExecutor,
